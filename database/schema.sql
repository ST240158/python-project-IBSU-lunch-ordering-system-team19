...
-- Demo credentials for assessment demonstration only.
-- Demo password hashes are generated by the application using salted PBKDF2.

INSERT INTO users (username, password_hash, role, name, contact_info) VALUES
    ('admin', 'pbkdf2_sha256$310000$00112233445566778899aabbccddeeff$f7727c0401998f9fba5bf39fdb86b605913396049639c404fa31ec9bc6f51393', 'admin', 'System Administrator', ''),
    ('student', 'pbkdf2_sha256$310000$ffeeddccbbaa99887766554433221100$e859cb591ac3c83ff3078aebbfb30a1a88eba5305f80721e74b29170e5be6125', 'student', 'Demo Student', 'student@ibsu.edu');
